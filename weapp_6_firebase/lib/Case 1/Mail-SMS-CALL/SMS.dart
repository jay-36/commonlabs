...
class DirectSmsDemo extends StatefulWidget {
  @override
  _DirectSmsDemoState createState() => _DirectSmsDemoState();
}

class _DirectSmsDemoState extends State<DirectSmsDemo> {
  ...
  void sendSMSNow() {
    ...
    SmsMessage message = SmsMessage(phoneController.text, smsController.text);
    message.onStateChanged.listen((state) {
      if (state == SmsMessageState.Sent) {
        print("SMS is sent!");
        setState(() {
          smsStatus = "SMS is sent!";
        });

      } else if (state == SmsMessageState.Delivered) {
        setState(() {
          smsStatus = "SMS is delivered!";
        });
      ...
      body: Center(
        child:  Form(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text(smsStatus,style: TextStyle(color: Colors.green),),
              Padding(
