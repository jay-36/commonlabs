...
class VideoViewerList extends StatefulWidget {
  @override
  _VideoViewerListState createState() => _VideoViewerListState();
}

class _VideoViewerListState extends State<VideoViewerList> {
  @override
  ...
  void _onImageButtonPressed() async {
    await _picker.getVideo(
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => FileDemo(path: value.path.toString()),));
    });
  }
}
